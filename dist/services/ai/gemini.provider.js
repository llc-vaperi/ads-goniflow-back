...
async function generateImage(params) {
    ...
    if (!imagePart?.inlineData?.data) {
        console.warn("[gemini.provider] generateImage returned no inline image data — finishReason:", response.candidates?.[0]?.finishReason, "promptFeedback:", response.promptFeedback);
        return null;
    }
...
export const geminiProvider = { generateText, generateImage };
